...
\noindent Les courbes d'apprentissage permettent d'analyser l'évolution de la politique au cours de l'entraînement (Figure \ref{fig:valid_exp3} et Figure \ref{fig:valid_exp7}).

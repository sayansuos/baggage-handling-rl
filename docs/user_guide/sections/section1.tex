...
\begin{itemize}
    ...
    \item un environnement virtuel Python, permettant d'isoler les dépendances du projet des autres installations Python présentes sur la machine.
\end{itemize}

\subsection{Installation}

\noindent Le projet est distribué sous la forme d'un dépôt Git. La première étape consiste donc à cloner le dépôt sur la machine locale :

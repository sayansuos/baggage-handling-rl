...
if __name__ == "__main__":
    ...
    if MODE == "demo":
        ...
        run_train(experiments=train_experiments[6:7], previous_exp=train_experiments[5])
        run_validation(experiments=train_experiments[6:7], n_episodes=100, n_render=5)

    elif MODE == "validation":
        run_validation(experiments=train_experiments[:5], n_episodes=100, n_render=5)

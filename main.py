...
if __name__ == "__main__":
    ...
    if MODE == "demo":
        ...
        run_train(experiments=train_experiments[2:3], previous_exp=train_experiments[1])
        run_validation(experiments=train_experiments[2:3], n_episodes=100, n_render=5)
